...
public class BattleController {
    ...
    public ResponseEntity<CommonResponseEntity> getUserBattleInfo(@RequestParam("userId") int userId){
        ...
        UserBattleInfo userBattleInfo = battleService.getUserBattleInfo(userId);

        log.info("BattleController getUserBattleInfo - userId: {}", userId);

        return CommonResponseEntity.toResponseEntity(GlobalSuccessCode.SUCCESS, userBattleInfo);
    }
